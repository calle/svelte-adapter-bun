...
Install with `bun add -d @calle.wester/svelte-adapter-bun`, then add the adapter to your `svelte.config.js`:
...
/** @type {import("@calle.wester/svelte-adapter-bun").WebSocketHandler} */
